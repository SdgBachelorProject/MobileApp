...
class ElectricityLesson1_3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_electricity_lesson1_3, container, false)
        val nextButton = view.findViewById<Button>(R.id.btn_next_lesson1_3)
        val prevButton = view.findViewById<Button>(R.id.btn_previous_lesson1_3)
